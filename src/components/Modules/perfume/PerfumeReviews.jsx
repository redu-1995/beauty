...
// 📦 Curated Dataset of Premium Fragrance Reviews
const perfumeReviews = [
  {
    id: "pf-rev-01",
    rating: 5,
    quote: "The fragrance lasts all day and smells amazing. I applied the Imperial Santal before heading out to an evening event in Bole, and I could still subtly catch the warm ambergris and woody sillage on my jacket the next morning!",
    author: "Selamawit A.",
    location: "Addis Ababa",
    tag: "Verified Purchase",
    profile: "Scent Match: Imperial Santal"
  },
  {
    id: "pf-rev-02",
    rating: 5,
    quote: "Elegant packaging and beautiful scent. The weighted glass bottle feels like true luxury on my vanity, and the magnetic cap is a beautiful touch. The jasmine and rose note breakdown is incredibly smooth.",
    author: "Meron K.",
    location: "Bole",
    tag: "Verified Purchase",
    profile: "Scent Match: Velvet Jasmine"
  },
  {
    id: "pf-rev-03",
    rating: 5,
    quote: "Perfect for daily wear. It balances crisp Italian bergamot with clean sea salt notes without being overpowering. I wear it to the office daily and always receive compliments. A true signature scent masterwork.",
    author: "Brook T.",
    location: "Megenagna",
    tag: "Verified Purchase",
    profile: "Scent Match: Sicilian Bergamot"
  }
];

export default function PerfumeReviews() {
  return (
      ...
      <div className="max-w-7xl mx-auto flex flex-col space-y-12">
        ...
        <div className="text-center max-w-xl mx-auto space-y-2">
          <span className="text-[10px] uppercase tracking-[0.25em] text-[#A47E6C] font-bold bg-[#FBE7D6]/50 px-3 py-1.5 rounded-full inline-block select-none">
            Aromatic Testimonials
          </span>
          <h2 className="font-serif text-[#4A3B32] font-bold text-2xl sm:text-3xl tracking-tight">
            The Sillage Impressions
          </h2>
          <p className="text-[#705A4F] text-xs sm:text-sm font-medium">
            Read authentic reviews from customers who have discovered their true olfactive signature within our luxury collection.
          </p>
        </div>
          ...
          {perfumeReviews.map((review) => (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <span className="text-[9px] font-sans font-bold uppercase tracking-wider text-[#A47E6C] bg-white border border-[#F2E3D5] px-2 py-0.5 rounded-md flex items-center gap-1 shadow-2xs select-none">
                    <i className="fa-solid fa-circle-check text-[#25D366] text-[10px]"></i> {review.tag}
                  </span>
                </div>

                {/* Main Review Quote Content Block */}
              ...
              <div className="pt-6 mt-6 border-t border-[#F1E7DE]/50 space-y-1.5 mt-auto">
                ...
                {/* Product Match Badge (Reduces purchasing friction by highlighting specific collection items) */}
